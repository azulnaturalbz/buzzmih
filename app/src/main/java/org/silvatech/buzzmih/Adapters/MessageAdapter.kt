package org.silvatech.buzzmih.Adapters
...
class MessageAdapter(val context: Context, val messages: ArrayList<Message>) :
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val timeStamp = itemView?.findViewById<TextView>(R.id.timestampLb)
        val userName = itemView?.findViewById<TextView>(R.id.messageUserNameLb)
        val messageBody = itemView?.findViewById<TextView>(R.id.messageBodyLb)
